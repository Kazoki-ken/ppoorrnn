...
def isVideoPhoto(url):
    ...
    """
    # Relaxed validation because URLs can be complex now and might not end in .jpg directly if they have query params
    # or they might not strictly follow VIDEO_IMAGE_URL pattern if cdn changed.
    return True
